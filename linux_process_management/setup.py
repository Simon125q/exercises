...
def setup_exercises():
    ...
    ex1_dir = os.path.join(base_dir, "01_advanced_ps_sorting")
    create_directory(ex1_dir)
    
    readme1 = """# Exercise 1: Advanced ps Sorting
...
"""
    write_file(os.path.join(ex1_dir, "README.md"), readme1)

    # Exercise 2: Interactive Monitoring and Management
    ex2_dir = os.path.join(base_dir, "02_interactive_monitoring")
    create_directory(ex2_dir)
    
    readme2 = """# Exercise 2: Interactive Monitoring and Management
...
"""
    write_file(os.path.join(ex2_dir, "README.md"), readme2)

    # Exercise 3: The Emergency Kill One-Liner
    ex3_dir = os.path.join(base_dir, "03_emergency_kill_chain")
    create_directory(ex3_dir)
    
    rogue_script = """#!/bin/bash
echo "Starting rogue process..."
while true; do
    :
done
"""
    write_file(os.path.join(ex3_dir, "rogue_process.sh"), rogue_script)
    os.chmod(os.path.join(ex3_dir, "rogue_process.sh"), 0o755)

    readme3 = """# Exercise 3: The Emergency Kill One-Liner
...
"""
    write_file(os.path.join(ex3_dir, "README.md"), readme3)

    # Exercise 4: Signal Mastery (SIGTERM vs SIGKILL)
    ex4_dir = os.path.join(base_dir, "04_signal_mastery")
    create_directory(ex4_dir)
    
    readme4 = """# Exercise 4: Signal Mastery (SIGTERM vs SIGKILL)
...
"""
    write_file(os.path.join(ex4_dir, "README.md"), readme4)

    print("Setup complete. Exercises created in 'exercises/' directory.")
